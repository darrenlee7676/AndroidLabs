...
public class ListItemsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch change = (Switch) findViewById(R.id.s);
        change.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            public void onCheckedChanged(CompoundButton switchchange, boolean isChecked) {
                ...
                if (switchchange.isChecked()) {
                    Toast toast = Toast.makeText(getApplicationContext(), R.string.ON, duration);
                    toast.show();

                } else {
                    Toast toast = Toast.makeText(getApplicationContext(),R.string.OFF , duration);
                    toast.show();
                }
